...
import {
  CSSTransition
} from "./chunk-2QLCUOPN.js";
import {
  SpinnerIcon
} from "./chunk-F45LDV55.js";
import {
  Portal,
  Tooltip
} from "./chunk-MIAPA6WR.js";
import {
  IconBase,
  Ripple
} from "./chunk-KPF4SCPI.js";
...
var VirtualScroller = React5.memo(React5.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React5.useState(both ? {
    rows: 0,
    cols: 0
  } : 0), _React$useState2 = _slicedToArray(_React$useState, 2), firstState = _React$useState2[0], setFirstState = _React$useState2[1];
  var _React$useState3 = React5.useState(both ? {
    rows: 0,
    cols: 0
  } : 0), _React$useState4 = _slicedToArray(_React$useState3, 2), lastState = _React$useState4[0], setLastState = _React$useState4[1];
  var _React$useState5 = React5.useState(0), _React$useState6 = _slicedToArray(_React$useState5, 2), pageState = _React$useState6[0], setPageState = _React$useState6[1];
  var _React$useState7 = React5.useState(both ? {
    rows: 0,
    cols: 0
  ...
  var _React$useState9 = React5.useState(props.numToleratedItems), _React$useState10 = _slicedToArray(_React$useState9, 2), numToleratedItemsState = _React$useState10[0], setNumToleratedItemsState = _React$useState10[1];
  var _React$useState11 = React5.useState(props.loading || false), _React$useState12 = _slicedToArray(_React$useState11, 2), loadingState = _React$useState12[0], setLoadingState = _React$useState12[1];
  var _React$useState13 = React5.useState([]), _React$useState14 = _slicedToArray(_React$useState13, 2), loaderArrState = _React$useState14[0], setLoaderArrState = _React$useState14[1];
  ...
  var _contentRef = React5.useRef(null);
  var _spacerRef = React5.useRef(null);
  var _stickyRef = React5.useRef(null);
  var lastScrollPos = React5.useRef(both ? {
    top: 0,
    left: 0
  } : 0);
  var scrollTimeout = React5.useRef(null);
  var resizeTimeout = React5.useRef(null);
  var contentStyle = React5.useRef({});
  var spacerStyle = React5.useRef({});
  var defaultWidth = React5.useRef(null);
  var defaultHeight = React5.useRef(null);
  var defaultContentWidth = React5.useRef(null);
  var defaultContentHeight = React5.useRef(null);
  var isItemRangeChanged = React5.useRef(false);
  var lazyLoadState = React5.useRef(null);
  var viewInitialized = React5.useRef(false);
  ...
  var createLoader = function createLoader2() {
    ...
    var icon = props.loadingIcon || React5.createElement(SpinnerIcon, _extends5({}, loadingIconProps, {
      spin: true
    }));
    ...
    if (!props.loaderDisabled && props.showLoader && loadingState) {
      ...
      return React5.createElement("div", loaderProps, _content);
    }
    return null;
  };
  var createSpacer = function createSpacer2() {
    if (props.showSpacer) {
      ...
      return React5.createElement("div", spacerProps);
    }
    return null;
  };
  ...
  var createContent = function createContent2() {
    ...
    var content2 = React5.createElement("div", contentProps, items);
  ...
  if (props.disabled) {
    ...
    return React5.createElement(React5.Fragment, null, props.children, _content2);
  }
  ...
  return React5.createElement("div", rootProps, content, spacer, loader);
}));
...
var CheckIcon = React6.memo(React6.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var BlankIcon = React7.memo(React7.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var DropdownItem = React7.memo(function(props) {
  var mergeProps = useMergeProps();
  ...
  var iconRenderer = function iconRenderer2() {
    if (selected) {
      ...
      return React7.createElement(CheckIcon, checkIconProps);
    }
    var blankIconProps = mergeProps({
      className: cx("blankIcon")
    }, getPTOptions("blankIcon"));
    return React7.createElement(BlankIcon, blankIconProps);
  };
  return React7.createElement("li", _extends7({
    key: props.label
  }, itemProps), checkmark && iconRenderer(), React7.createElement("span", itemGroupLabelProps, content), React7.createElement(Ripple, null));
});
...
var DropdownPanel = React7.memo(React7.forwardRef(function(props, ref) {
  var mergeProps = useMergeProps();
  var ptm = props.ptm, cx = props.cx, sx = props.sx;
  var context = React7.useContext(PrimeReactContext);
  var filterInputRef = React7.useRef(null);
  ...
  var createFooter = function createFooter2() {
    if (props.panelFooterTemplate) {
      ...
      return React7.createElement("div", footerProps, content);
    }
    return null;
  };
  ...
  var createEmptyMessage = function createEmptyMessage2(emptyMessage, isFilter) {
    ...
    return React7.createElement("li", emptyMessageProps, message);
  };
  var createItem = function createItem2(option, index) {
    ...
    if (option.group && props.optionGroupLabel) {
      ...
      return React7.createElement("li", _extends7({
        key
      }, itemGroupProps), React7.createElement("span", itemGroupLabelProps, groupContent));
    }
    var optionKey = props.getOptionRenderKey(option) + "_" + index;
    var optionLabel = props.getOptionLabel(option);
    var disabled = props.isOptionDisabled(option);
    return React7.createElement(DropdownItem, {
      key: optionKey,
      label: optionLabel,
      index,
  ...
  var createFilterClearIcon = function createFilterClearIcon2() {
    if (props.showFilterClear && props.filterValue) {
      ...
      var icon = props.filterClearIcon || React7.createElement(TimesIcon, clearIconProps);
  ...
  var createFilter = function createFilter2() {
    if (props.filter) {
      ...
      var icon = props.filterIcon || React7.createElement(SearchIcon, filterIconProps);
      ...
      var content = React7.createElement("div", filterContainerProps, React7.createElement("input", filterInputProps), clearIcon, filterIcon);
      ...
      return React7.createElement("div", headerProps, content);
    }
    return null;
  };
  var createContent = function createContent2() {
    if (props.virtualScrollerOptions) {
      var virtualScrollerProps = _objectSpread$1(_objectSpread$1({}, props.virtualScrollerOptions), {
        ...
        contentTemplate: function contentTemplate(options) {
          ...
          return React7.createElement("ul", listProps2, content);
        }
      });
      return React7.createElement(VirtualScroller, _extends7({
    ...
    return React7.createElement("div", wrapperProps, React7.createElement("ul", listProps, items));
  };
  var createElement8 = function createElement9() {
    ...
    return React7.createElement(CSSTransition, _extends7({
      nodeRef: ref
    }, transitionProps), React7.createElement("div", _extends7({
      ref
...
var Dropdown = React7.memo(React7.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React7.useContext(PrimeReactContext);
  ...
  var _React$useState = React7.useState(false), _React$useState2 = _slicedToArray2(_React$useState, 2), focusedState = _React$useState2[0], setFocusedState = _React$useState2[1];
  var _React$useState3 = React7.useState(-1), _React$useState4 = _slicedToArray2(_React$useState3, 2), focusedOptionIndex = _React$useState4[0], setFocusedOptionIndex = _React$useState4[1];
  var _React$useState5 = React7.useState(false), _React$useState6 = _slicedToArray2(_React$useState5, 2), overlayVisibleState = _React$useState6[0], setOverlayVisibleState = _React$useState6[1];
  var clickedRef = React7.useRef(false);
  var elementRef = React7.useRef(null);
  var overlayRef = React7.useRef(null);
  var firstHiddenFocusableElementOnOverlay = React7.useRef(null);
  var lastHiddenFocusableElementOnOverlay = React7.useRef(null);
  var inputRef = React7.useRef(props.inputRef);
  var focusInputRef = React7.useRef(props.focusInputRef);
  var virtualScrollerRef = React7.useRef(null);
  var searchTimeout = React7.useRef(null);
  var searchValue = React7.useRef(null);
  ...
  var createHiddenSelect = function createHiddenSelect2() {
    ...
    return React7.createElement("div", hiddenSelectedMessageProps, React7.createElement("select", selectProps, React7.createElement("option", optionProps, option.label)));
  };
  var createKeyboardHelper = function createKeyboardHelper2() {
    ...
    return React7.createElement("div", hiddenSelectedMessageProps, React7.createElement("input", inputProps));
  };
  var createLabel = function createLabel2() {
    ...
    var content = props.valueTemplate ? ObjectUtils.getJSXElement(props.valueTemplate, selectedOption, props) : label || props.placeholder || props.emptyMessage || React7.createElement(React7.Fragment, null, " ");
    ...
    return React7.createElement("span", inputProps, content);
  };
  ...
  var createClearIcon = function createClearIcon2() {
    if (props.value != null && props.showClear && !props.disabled && !ObjectUtils.isEmpty(props.options)) {
      ...
      var icon = props.clearIcon || React7.createElement(TimesIcon, clearIconProps);
  ...
  var createLoadingIcon = function createLoadingIcon2() {
    ...
    var icon = props.loadingIcon || React7.createElement(SpinnerIcon, {
      spin: true
    });
    ...
    return React7.createElement("div", loadingButtonProps, loadingIcon);
  };
  var createDropdownIcon = function createDropdownIcon2() {
    ...
    var icon = !overlayVisibleState ? props.dropdownIcon || React7.createElement(ChevronDownIcon, dropdownIconProps) : props.collapseIcon || React7.createElement(ChevronUpIcon, dropdownIconProps);
    ...
    return React7.createElement("div", triggerProps, dropdownIcon2);
  };
  ...
  return React7.createElement(React7.Fragment, null, React7.createElement("div", rootProps, keyboardHelper, hiddenSelect, labelElement, clearIcon, dropdownIcon, React7.createElement(DropdownPanel, _extends7({
    hostName: "Dropdown",
    ref: overlayRef,
    visibleOptions,
    virtualScrollerRef
    ...
    firstFocusableElement: React7.createElement("span", firstHiddenFocusableElementProps),
    lastFocusableElement: React7.createElement("span", lastHiddenFocusableElementProps),
    sx
  }))), hasTooltip && React7.createElement(Tooltip, _extends7({
    target: elementRef,
